// Seller-facing section. To edit body copy, update the paragraphs directly below.
      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="space-y-4 mb-8">
          <p className="text-slate-600 text-lg leading-relaxed">
            ...
            next buyer in three to seven years. Your team gets disrupted. Your customers notice. What
